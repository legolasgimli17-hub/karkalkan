...
function humanError(error) {
  ...
  const map = {
    ...
    'INVALID_BANK_ACCOUNT_LABEL': 'Hesap etiketi veya son 4 karakter alanı geçersiz.',
    'INVALID_BANK_IMPORT_SIZE': 'Ekstre 1–5.000 hareket arasında olmalı.',
    'INVALID_BANK_IMPORT_ROW': 'Ekstre satırlarından biri geçersiz. CSV şablonundaki biçimi kullan.',
    'BANK_IMPORT_PERIOD_TOO_LARGE': 'Tek ekstre aktarımı en fazla 370 günlük dönem içerebilir.',
    'DUPLICATE_BANK_IMPORT': 'Bu ekstre daha önce içe aktarılmış.',
    'BANK_IMPORT_FAILED': 'Ekstre güvenli biçimde içe aktarılamadı. Dosya biçimini kontrol et.',
    'BANK_LEDGER_TOO_LARGE': 'Banka kontrolünde gösterilebilecek hareket sınırı aşıldı. Daha kısa dönem kullan.',
    'INVALID_RECONCILIATION_REVIEW': 'Mutabakat kararı geçersiz veya eksik.',
    'RECONCILIATION_CANDIDATE_CHANGED': 'Finans verisi değiştiği için aday güncellendi. Listeyi yenileyip tekrar incele.',
    'BANK_TRANSACTION_NOT_FOUND': 'Banka hareketi bulunamadı veya erişim iznin yok.',
    'BANK_RECONCILIATION_FAILED': 'Banka kontrolü şu anda tamamlanamadı.',
