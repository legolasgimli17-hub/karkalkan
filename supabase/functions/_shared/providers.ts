...
export const PROVIDERS:Record<MarketplaceKey,{
  ...
  hepsiburada:{label:'Hepsiburada',mode:'api',tier:'beta',sellerIdLabel:'Merchant ID',sellerIdRequired:true,credentialFields:[{key:'username',label:'Entegrasyon kullanıcı adı',max:220},{key:'password',label:'Entegrasyon şifresi',max:320}],capabilities:['Sipariş bağlantısı','Muhasebe raporu','CSV içe aktarma'],note:'Resmî OMS ve muhasebe API erişimi mağaza hesabına göre doğrulanır.'},
